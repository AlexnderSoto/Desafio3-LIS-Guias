...
?>
 ...
 <input class="formcontrol" type="text" name="cantidad" id="cantidad" maxlength="1" placeholder
="Cantidad" pattern="\d{1}" required /><br />
 <input type="submit" name="comprar" value="Comprar" class="btn b
tn-primary" />
 </fieldset>
 </form>
