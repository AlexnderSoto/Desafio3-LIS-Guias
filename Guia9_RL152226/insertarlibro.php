...
";
            ...
            echo $sentencia->affected_rows . " libro(s) agregado(s) a la base de
datos\n";
            echo "</p>\n</div>\n";
            $sentencia->close();
            /*
            ...
            <section class="m-b-30 m-t-30">
                <div class="row pager">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="nuevolibro.html" class="d-block h3 font-weightnormal">
                            Agregar<br>
                            <small class="d-block text-muted text-small">Otro
                                libro</small>
                        </a>
                    </div>
