...
<head>
    ...
    <link rel="stylesheet" href="css/links.css" /> <!-- <link rel="stylesheet"
href="css/libros.css" /> -->
    ...
    <section>
        <article> <?php
                    ...
                    if (empty($tema) || empty($termino)) {
                        ...
                        $msg .= "Regrese al formulario e ingrese los datos en el
formulario.<br>";
...
$num_results</p>\n</div>\n";
                    ...
                    for ($i = 0; $i < $num_results; $i++) {
                        ...
                        echo "<div class='card-header bg-info'>Libro " . ($i +
                            1) . "</div>";
                        echo "<div class='card-body'>";
                        echo " <ul class='list-group list-group-flush'>";
                        echo "<li class='list-group-item'>Título " . ($i + 1) .
                            ":" . stripslashes($row['titulo']) . "</li>";
...
:" . stripslashes($row['precio']) . "</li>";
                    ...
                    /* $msg = "<p>[<a href=\"busquedalibro.html\">realizar otra
búsqueda</a>]&nbsp&nbsp"; $msg .= "[<a href=\"menuopciones.html\">volver al
menú</a>]</p>"; echo $msg; */
                    $resultc->free();
                    $db->close(); ?>
            ...
            <section class="m-b-30 m-t-30">
                <div class="row pager">
                    <div class="col-md-6 text-left">
                        <a href="menuopciones.html" class="d-block h3 fontweight-normal">Regresar<br>
                            <small class="d-block text-muted text-small">Menu</small>
                        </a>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="busquedalibro.html" class="d-block h3 fontweight-normal">
                            Realizar<br>
                            <small class="d-block text-muted text-small">Otra
                                busqueda</small>
                        </a>
                    </div>
                </div>
