...
datos";
            ...
            <form action="mostrarlibros.php?id=<?php
                                                echo $_GET['id'] ?>" method="POST" class="formoidsolid-purple">
 ...
 <input type="submit" name="guardar" value="Guardar" /> </div>
            ...
            <a href="mostrarlibros.php?opc=modificar" class="d-block h3 fontweight-normal">Volver<br>
                <small class="d-block text-muted text-small">a la tabla de
                    modificación</small>
            </a>
        </article>
    </section>
