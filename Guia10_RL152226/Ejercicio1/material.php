        ...
        <header>
            <div class="row">
                ...
                <div class="col-3 float-right">
                    <a href="logout.php" class="btn btn-primary btn-lg " role="button" ariadisabled="true">Cerrar sesión</a>
                </div>
            </div>
            </div>
        </header>
...
+Estructuras+de+control+sentencias+condicionales+y+repetitivas+-+2014.pdf" target="_blank">
                            Clase 03: Estructuras de control - Sentencias condicionales y
                            repetitivas
                        </a>
                    </li>
                </ul>
                <ul class="list-group">
                    ...
                    <li class="list-group-item ">
                        <a href="http://www.udb.edu.sv/udb/archivo/guia/informaticatecnologico/lenguajes-interpretados-en-el-servidor/2014/i/guia-1.pdf" target="_blank">
                            Guía 01: Introducción a la Progamación web con PHP
                        </a>
                    </li>
                    <li class="list-group-item ">
                        <a href="http://www.udb.edu.sv/udb/archivo/guia/informaticatecnologico/lenguajes-interpretados-en-el-servidor/2014/i/guia-2.pdf" target="_blank">
                            Guía 02: Estructuras de Control - Sentencias condicionales y
                            repetitivas
                        </a>
                    </li>
                    <li class="list-group-item ">
                        <a href="http://www.udb.edu.sv/udb/archivo/guia/informaticatecnologico/lenguajes-interpretados-en-el-servidor/2014/i/guia-3.pdf" target="_blank">
